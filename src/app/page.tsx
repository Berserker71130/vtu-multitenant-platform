...
export default function RootLandingPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-blue-500 selection:text-white relative overflow-hidden">
      ...
      <nav className="sticky top-0 z-50 border-b border-slate-800/80 bg-slate-950/80 backdrop-blur-xl px-6 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <Link
              href="/dashboard"
              className="px-4 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 text-slate-300 hover:text-white text-xs font-semibold transition-all flex items-center gap-2"
            >
      ...
      <section className="max-w-7xl mx-auto px-6 pt-20 pb-16 text-center">
        ...
        >
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-slate-900 border border-slate-800 text-xs font-medium text-slate-300 mb-6 shadow-xl">
          ...
          <p className="mt-6 text-slate-400 text-base sm:text-lg max-w-2xl mx-auto font-normal">
        ...
        <motion.div
          ...
          className="mt-10 max-w-2xl mx-auto p-2 sm:p-2.5 rounded-2xl bg-slate-900/90 border border-slate-800 shadow-2xl backdrop-blur-md"
        >
          <form
            onSubmit={handleLaunchStorePreview}
            className="flex flex-col sm:flex-row items-center gap-2"
          >
            <div className="flex items-center gap-2 px-3 py-2 w-full bg-slate-950 rounded-xl border border-slate-800 text-sm text-slate-400">
              ...
              <input
                ...
                className="bg-transparent text-white font-bold outline-none w-full placeholer:text-slate-600"
              />
            </div>
            <button
              type="submit"
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        <div className="p-8 rounded-3xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-xl relative overflow-hidden">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="p-6 rounded-2xl bg-slate-950/80 border border-slate-800/90 text-center flex flex-col justify-center">
              <span className="text-xs font-semibold text-slate-400 uppercase tracking-wider">
                Estimated Monthly Net Profit
              </span>
              <h3 className="text-4xl sm:text-5xl font-black text-emerald-400 mt-2">
              ...
              <Link
                href="/dashboard"
                className="mt-6 w-full py-3 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs uppercase tracking-wider transition-all flex items-center justify-center gap-2"
              >
      ...
      <section className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-slate-900/50 border-slate-800">
      ...
      <section className="max-w-7xl mx-auto px-6 py-12 border-t border-slate-800/80">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          <Link
            href="/apex-telecom"
            className="p-4 rounded-xl bg-slate-900 border border-slate-800 hover:border-blue-500/50 transition-all flex items-center justify-between group"
          >
            <div className="flex items-center gap-3">
            ...
            <ArrowRight className="w-4 h-4 text-slate-600 group-hover:text-blue-400 group-hover:translate-x-1 trasition-all" />
          </Link>

          <Link
            href="/power-connect"
            className="p-4 rounded-xl bg-slate-900 border border-slate-800 hover:border-indigo-500/50 transition-all flex items-center justify-between group"
          >
            <div className="flex items-center gap-3">
          ...
          <Link
            href="/dashboard"
            className="p-4 rounded-xl bg-slate-900 border border-slate-800 hover:border-emerald-500/50 transition-all flex items-center justify-between group"
          >
            <div className="flex items-center gap-3">
            ...
            <ArrowRight className="w-4 h-4 text-slate-600 group-hover:text-emeraled-400 group-hover:translate-x-1 transition-all" />
          </Link>
        </div>
      </section>
