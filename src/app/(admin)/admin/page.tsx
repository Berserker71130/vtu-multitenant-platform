...
export default function SuperAdminConsolePage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100 selection:bg-cyan-500 selection:text-black relative overflow-hidden pb-16">
        ...
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="px-2 py-0.5 text-[9px] font-black uppercase tracking-wider rounded-md bg-cyan-500/10 text-cyan-400 border border-cyan-500/30">
                  Super Admin
                </span>
              </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              disabled={isSyncing}
              className="px-4 py-2 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 text-xs font-bold text-slate-300 transition-all flex items-center gap-2"
            >
              <RefreshCw
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 pt-8 space-y-8">
        {/* Metric Cards - Globl Platform Health */}
        <section className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          <motion.div
            whileHover={{ y: -2 }}
            className="p-5 rounded-2xl bg-gradient-to-b from-slate-900/90 to-slate-900/40 border border-slate-800 shadow-xl backdrop-blur-md relative overflow-hidden"
          >
          ...
          >
            ...
            <h2 className="text-2xlsm:text-3xl font-black text-emerald-400">
              ₦1,850,400
            </h2>
            <p className="text-xs text-slate-400 font-medium mt-2">
          ...
          <motion.div
            whileHover={{ y: -2 }}
            className="p-5 rounded-2xl bg-gradient-to-b from-slate-900/90 to-slate-900/40 border border-slte-800 shadow-xl backdrop-blur-md relative overflow-hidden"
          >
            <div className="flex items-center justify-between mb-3">
              <span className="text-xs font-bold uppercase tracking-wider text-slate-400">
        ...
        <section className="rounded-3xl bg-slate-900/60 border border-slate-800 p-6 backdrop-blur-xl">
          <div className="flex items-center justify-between mb-6">
            <div>
              <h3 className="text-base font-black text-white uppercase tracking-wider flex items-center gap-2">
                <Cpu className="w-4 h-4 text-cyan-400" /> Network Provider
                Integration Matrix
              </h3>
              <p className="text-xs text-slate-400 mt-1">
                Liveconnection telemetry with upstream VTU servers.
              </p>
            </div>
            <span className="text-[10px] font-mono px-2.5 py-1 rounded-md bg-slate-950 text-slate-400 border border-slate-800">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              <div
                key={provider.name}
                className="p-4 rounded-2xl bg-slate-950/80 border border-slate-800/80"
              >
        ...
        <section className="rounded-3xl bg-slate-900/60 border border-slate-800 backdrop-blur-xl overflow-hidden">
          <div className="p-6 border-b border-slate-800 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="px-3 py-1.5 rounded-xl bg-slate-950 border border-slate-800 text-xs text-slate-400 font-mono">
              Total Tenant Count:{" "}
        ...
        <section className="p-6 rounded-3xl bg-slate-900/30 border border-dashed border-slate-800 text-center">
          <div className="w-10 h-10 rounded-2xl bg-slate-900 border border-slate-800 text-cyan-400 flex items-center justify-center mx-auto mb-3">
